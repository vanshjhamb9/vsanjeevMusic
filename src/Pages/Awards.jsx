...
const Awards = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen py-12 px-6 md:px-20">
      <h1 className="text-4xl font-bold p-8 border-b-2 border-white text-center mb-10">Awards & Recognition</h1>
      ...
      <div className="space-y-8 lg:p-[4rem] md:p-[4rem] sm:p-[2rem] xs:p-[1rem] mt-[8rem] ">
        {awardsData.map((award, index) => (
          <div key={index} className="border-l-4 border-yellow-500 pl-4">
            ...
            <p className="text-lg text-gray-300">{award.event}, {award.year}</p>
          </div>
        ))}
        </div>
      ...
      <div className="mt-6 space-y-6">
        <div className="border-l-4 border-blue-500 pl-4">
          <h3 className="text-2xl font-semibold">Lost in Harmony: A Tribute to Nature</h3>
          <p className="text-lg text-gray-300">
            The Hindu highlights Sanjeev Venkataramanan’s award-winning short film,
            <span className="font-semibold"> Lost in Harmony</span>, which beautifully
            captures the mystical sounds and visuals of South India’s forests.
          </p>
          <a
        ...
        <div className="border-l-4 border-green-500 pl-4">
          <h3 className="text-2xl font-semibold">World Environment Day Feature</h3>
          <p className="text-lg text-gray-300">
            The Times of India covers the screening of <span className="font-semibold">Lost in Harmony</span>
            on World Environment Day, showcasing the connection between music and nature.
          </p>
          <a
